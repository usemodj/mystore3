...
ActiveRecord::Schema.define(:version => 20130708003223) do
  ...
  create_table "spree_products_questions", :id => false, :force => true do |t|
    t.integer "product_id"
    t.integer "question_id"
  end

  add_index "spree_products_questions", ["product_id"], :name => "index_spree_products_questions_on_product_id"
  add_index "spree_products_questions", ["question_id"], :name => "index_spree_products_questions_on_question_id"
  ...
  add_index "spree_questions", ["slug"], :name => "index_spree_questions_on_slug"

  create_table "spree_questions_taxons", :id => false, :force => true do |t|
    t.integer "question_id"
    t.integer "taxon_id"
  end

  add_index "spree_questions_taxons", ["question_id"], :name => "index_spree_questions_taxons_on_question_id"
  add_index "spree_questions_taxons", ["taxon_id"], :name => "index_spree_questions_taxons_on_taxon_id"
